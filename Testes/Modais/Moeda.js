function inicializarMoeda() {
    ...
    const inputTeste = document.getElementById('Teste'); // ID correto para o campo Benefícios
    ...
    if (inputTeste) {
        ...
        console.error("Erro: input Teste não encontrado!");
    }
    ...
    if (algumCampoEncontrado) {
        ...
        if (inputTeste) inputTeste.value = "R$ 0,00";
        ...
        if (inputTeste) inputTeste.addEventListener('input', atualizarValor);
        ...
        if (inputTeste) inputTeste.addEventListener('blur', garantirValorMinimo);
